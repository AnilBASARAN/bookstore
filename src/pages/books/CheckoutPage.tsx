...
const totalPrice = cartItems.reduce((acc,item)=> acc + item.newPrice, 0).toFixed(2) || 0 ;
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-5 mt-3">
                                    <div className="inline-flex items-center">
                                        <input  {...register("billing_same", { required: true })}
                                        type="checkbox" name="billing_same" id="billing_same" className="form-checkbox" />
                                        <label htmlFor="billing_same" className="ml-2 ">I am aggree to the <Link to={"/"} className='underline underline-offset-2 text-blue-600'>Terms & Conditions</Link> and <Link to={"/"} className='underline underline-offset-2 text-blue-600'>Shoping Policy.</Link></label>
                                    </div>
                                </div>
